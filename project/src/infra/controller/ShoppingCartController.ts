...
export default class ShoppingCartController {
    ...
    constructor(readonly http: Http, readonly productRepository: ProductRepository, readonly discountRepository: DiscountCodeRepository, readonly shoppingCartRepository: ShoppingCartRepository, readonly shoppingCartIdGenerator: ShoppingCartIdGenerator) {
        http.on("get", "/shoppingCart/:shoppingCartId", async function (params: any, body: any): Promise<any> {
            const shoppingCartUseCases = new ShoppingCartUseCases(productRepository, discountRepository, shoppingCartRepository, shoppingCartIdGenerator);
